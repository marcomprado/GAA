...
- Include relevant log excerpts when reporting
...
**Recent Updates:**
- Implemented filtering based on filename patterns (`name_contains`, `name_starts_with`)
- Multi-file movement working reliably
- Watcher and rules system refined
- Worker pool for concurrent processing
- Core file monitoring with fsnotify
